...
import { type Ubication, type InventoryProscai } from 'src/interfaces/Inventory'
...
export const ListOfInventories: React.FC = () => {
  ...
  const expandedColumns: ColumnsType<Ubication> = [
    {
      title: 'Iseq',
      dataIndex: 'iseq',
      width: '20%',
    ...
    },
    {
      title: 'Almacen',
      dataIndex: 'code',
      render: (_, value) => value.branchOffice.code
    },
    {
      title: 'cantidad',
      dataIndex: 'inventory',
